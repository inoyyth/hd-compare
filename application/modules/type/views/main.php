<div class="row-fluid">
    <div class="span12">
        <div class="widget-box">
            ...
            <a id="btn-add" href="<?php echo site_url('type/add');?>" class="label btn btn-success">New</a>
            </div>
...
<script>
    $(document).ready(function () {
        $("#main-list-table").tabulator({
            ...
            ajaxURL: "<?php echo base_url('type/getListTable'); ?>", //ajax URL
            ...
            rowSelectionChanged: function (data, rows) {
                console.log(data);
                if (data.length > 0) {
                    $('#btn-edit').attr('href', '<?php echo site_url(); ?>type-edit-' + data[0]['id'] + '.html');
                    $('#btn-delete').attr('href', '<?php echo site_url(); ?>type-delete-' + data[0]['id'] + '.html');
                } else {
                    $('#btn-edit').attr('href', '#');
            ...
            rowDblClick:function(e, row){
                location.replace('<?php echo site_url(); ?>type-edit-' + row + '.html');
            },
        });
    });
    ...
    function filterTable() {
        ...
        $("#main-list-table").tabulator("setData", "<?php echo base_url('md_area/getListTable'); ?>", params);
    }
</script>